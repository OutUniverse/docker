...
@alloc15 = private unnamed_addr constant <{ i8*, [0 x i8] }> <{ i8* bitcast (i64* ()* @_ZN6probe15probe8MY_PROBE7__getit17h3eb16cc1f7cd4462E to i8*), [0 x i8] zeroinitializer }>, align 8
@_ZN6probe15probe8MY_PROBE7__getit3VAL17h606e30fc429c9730E = internal thread_local global <{ [8 x i8] }> <{ [8 x i8] c"\0A\00\00\00\00\00\00\00" }>, section "__DATA,__thread_data", align 8
@_ZN6probe15probe8MY_PROBE7__getit5STATE17h44c7388d355438ccE = internal thread_local global <{ [1 x i8] }> zeroinitializer, section "__DATA,__thread_bss", align 1
...
@alloc44 = private unnamed_addr constant <{ [88 x i8] }> <{ [88 x i8] c"/private/tmp/rust-20220304-60118-2krfor/rustc-1.59.0-src/library/std/src/thread/local.rs" }>, align 1
@alloc26 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [88 x i8] }>, <{ [88 x i8] }>* @alloc44, i32 0, i32 0, i32 0), [16 x i8] c"X\00\00\00\00\00\00\00\84\01\00\00\1A\00\00\00" }>, align 8
@alloc45 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [88 x i8] }>, <{ [88 x i8] }>* @alloc44, i32 0, i32 0, i32 0), [16 x i8] c"X\00\00\00\00\00\00\00\9B\01\00\00 \00\00\00" }>, align 8
@vtable.0 = private unnamed_addr constant <{ i8*, [16 x i8], i8*, [0 x i8] }> <{ i8* bitcast (void (i8**)* @"_ZN4core3ptr27drop_in_place$LT$$RF$u8$GT$17h9b7d82462ca3d9d9E" to i8*), [16 x i8] c"\08\00\00\00\00\00\00\00\08\00\00\00\00\00\00\00", i8* bitcast (i1 (i8**, %"core::fmt::Formatter"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h632d559c5d1a455fE" to i8*), [0 x i8] zeroinitializer }>, align 8
@vtable.1 = private unnamed_addr constant <{ i8*, [16 x i8], i8*, [0 x i8] }> <{ i8* bitcast (void (%"std::thread::local::AccessError"*)* @"_ZN4core3ptr52drop_in_place$LT$std..thread..local..AccessError$GT$17hfa65cb786ab1fc3eE" to i8*), [16 x i8] c"\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00", i8* bitcast (i1 (%"std::thread::local::AccessError"*, %"core::fmt::Formatter"*)* @"_ZN68_$LT$std..thread..local..AccessError$u20$as$u20$core..fmt..Debug$GT$3fmt17hbf585db32979d6afE" to i8*), [0 x i8] zeroinitializer }>, align 8

; core::ptr::drop_in_place<&u8>
; Function Attrs: inlinehint uwtable
define internal void @"_ZN4core3ptr27drop_in_place$LT$$RF$u8$GT$17h9b7d82462ca3d9d9E"(i8** %_1) unnamed_addr #0 {
start:
  ret void
}
...
; Function Attrs: inlinehint uwtable
define internal void @"_ZN4core3ptr52drop_in_place$LT$std..thread..local..AccessError$GT$17hfa65cb786ab1fc3eE"(%"std::thread::local::AccessError"* %_1) unnamed_addr #0 {
start:
  ret void
}
...
; call std::thread::local::LocalKey<T>::with
  %_1 = call i64 @"_ZN3std6thread5local17LocalKey$LT$T$GT$4with17hd51f8eb6dfa2be16E"(i64** align 8 dereferenceable(8) bitcast (<{ i8*, [0 x i8] }>* @alloc15 to i64**))
  br label %bb1
...
; Function Attrs: inlinehint uwtable
define internal align 8 dereferenceable_or_null(8) i64* @_ZN6probe15probe8MY_PROBE7__getit17h3eb16cc1f7cd4462E() unnamed_addr #0 {
start:
  %0 = alloca i64*, align 8
; call core::mem::needs_drop
  %_2 = call zeroext i1 @_ZN4core3mem10needs_drop17hb03ff01476ac29b6E()
  br label %bb1
...
; call std::thread::local::fast::Key<T>::register_dtor
  call void @"_ZN3std6thread5local4fast12Key$LT$T$GT$13register_dtor17h4653162a15c3e290E"(i8* getelementptr inbounds (<{ [8 x i8] }>, <{ [8 x i8] }>* @_ZN6probe15probe8MY_PROBE7__getit3VAL17h606e30fc429c9730E, i32 0, i32 0, i32 0), void (i8*)* nonnull @_ZN6probe15probe8MY_PROBE7__getit7destroy17hbda5ddb38fccf0b3E)
  br label %bb6
...
; Function Attrs: uwtable
define i64 @"_ZN3std6thread5local17LocalKey$LT$T$GT$4with17hd51f8eb6dfa2be16E"(i64** align 8 dereferenceable(8) %self) unnamed_addr #1 {
start:
; call std::thread::local::LocalKey<T>::try_with
  %0 = call { i64, i64 } @"_ZN3std6thread5local17LocalKey$LT$T$GT$8try_with17h89670065311c9166E"(i64** align 8 dereferenceable(8) %self)
...
; call core::result::Result<T,E>::expect
  %1 = call i64 @"_ZN4core6result19Result$LT$T$C$E$GT$6expect17hee85f869d9a4d833E"(i64 %_3.0, i64 %_3.1, [0 x i8]* nonnull align 1 bitcast (<{ [70 x i8] }>* @alloc24 to [0 x i8]*), i64 70, %"core::panic::location::Location"* align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc26 to %"core::panic::location::Location"*))
  br label %bb2
...
; Function Attrs: inlinehint uwtable
define { i64, i64 } @"_ZN3std6thread5local17LocalKey$LT$T$GT$8try_with17h89670065311c9166E"(i64** align 8 dereferenceable(8) %self) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception"*, %"unwind::libunwind::_Unwind_Context"*)* @rust_eh_personality {
start:
...
; invoke core::option::Option<T>::ok_or
  %_5 = invoke align 8 dereferenceable_or_null(8) i64* @"_ZN4core6option15Option$LT$T$GT$5ok_or17hc7c40345e9f62591E"(i64* align 8 dereferenceable_or_null(8) %_6)
...
; invoke <core::result::Result<T,E> as core::ops::try_trait::Try>::branch
  %10 = invoke align 8 dereferenceable_or_null(8) i64* @"_ZN79_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$core..ops..try_trait..Try$GT$6branch17h387e6161234b7a0bE"(i64* align 8 dereferenceable_or_null(8) %_5)
...
; Function Attrs: uwtable
define void @"_ZN3std6thread5local4fast12Key$LT$T$GT$13register_dtor17h4653162a15c3e290E"(i8* %a, void (i8*)* nonnull %dtor) unnamed_addr #1 {
start:
; call std::sys::unix::thread_local_dtor::register_dtor
  call void @_ZN3std3sys4unix17thread_local_dtor13register_dtor17h72ecae9b26a9e6cdE(i8* %a, void (i8*)* nonnull %dtor)
  br label %bb1
...
; core::mem::needs_drop
; Function Attrs: inlinehint uwtable
define zeroext i1 @_ZN4core3mem10needs_drop17hb03ff01476ac29b6E() unnamed_addr #0 {
start:
  %0 = alloca i8, align 1
...
; Function Attrs: uwtable
define void @"_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17h21b972cde9379db8E"() unnamed_addr #1 {
start:
  ret void
}
...
; Function Attrs: inlinehint uwtable
define align 8 dereferenceable_or_null(8) i64* @"_ZN4core6option15Option$LT$T$GT$5ok_or17hc7c40345e9f62591E"(i64* align 8 dereferenceable_or_null(8) %0) unnamed_addr #0 {
start:
...
define void @_ZN4core9panicking13assert_failed17hce2ea9e68422432cE(i8 %kind, i8* align 1 dereferenceable(1) %0, i8* align 1 dereferenceable(1) %1, %"core::option::Option<core::fmt::Arguments>"* noalias nocapture dereferenceable(48) %args, %"core::panic::location::Location"* align 8 dereferenceable(24) %2) unnamed_addr #2 {
start:
...
; invoke core::result::unwrap_failed
  invoke void @_ZN4core6result13unwrap_failed17hf19da9b6244b79beE([0 x i8]* nonnull align 1 %msg.0, i64 %msg.1, {}* nonnull align 1 %_6.0, [3 x i64]* align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8], i8*, [0 x i8] }>* @vtable.1 to [3 x i64]*), %"core::panic::location::Location"* align 8 dereferenceable(24) %2) #6
...
; Function Attrs: inlinehint uwtable
define align 8 dereferenceable_or_null(8) i64* @"_ZN79_$LT$core..result..Result$LT$T$C$E$GT$$u20$as$u20$core..ops..try_trait..Try$GT$6branch17h387e6161234b7a0bE"(i64* align 8 dereferenceable_or_null(8) %0) unnamed_addr #0 {
start:
...
; Function Attrs: inlinehint uwtable
define { i64, i64 } @"_ZN153_$LT$core..result..Result$LT$T$C$F$GT$$u20$as$u20$core..ops..try_trait..FromResidual$LT$core..result..Result$LT$core..convert..Infallible$C$E$GT$$GT$$GT$13from_residual17h292747231def68d3E"(%"core::panic::location::Location"* align 8 dereferenceable(24) %0) unnamed_addr #0 {
start:
  %1 = alloca { i64, i64 }, align 8
; call <T as core::convert::From<T>>::from
  call void @"_ZN50_$LT$T$u20$as$u20$core..convert..From$LT$T$GT$$GT$4from17h21b972cde9379db8E"()
  br label %bb1
...
; Function Attrs: inlinehint uwtable
define internal zeroext i1 @"_ZN4core3fmt3num49_$LT$impl$u20$core..fmt..Debug$u20$for$u20$u8$GT$3fmt17h59b60e76c3e689b6E"(i8* align 1 dereferenceable(1) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %0 = alloca i8, align 1
; call core::fmt::Formatter::debug_lower_hex
  %_3 = call zeroext i1 @_ZN4core3fmt9Formatter15debug_lower_hex17h898b568dc3d01406E(%"core::fmt::Formatter"* align 8 dereferenceable(64) %f)
  br label %bb1
...
; call core::fmt::Formatter::debug_upper_hex
  %_7 = call zeroext i1 @_ZN4core3fmt9Formatter15debug_upper_hex17h961ff7a2fc077a54E(%"core::fmt::Formatter"* align 8 dereferenceable(64) %f)
  br label %bb5

bb2:                                              ; preds = %bb1
; call core::fmt::num::<impl core::fmt::LowerHex for u8>::fmt
  %1 = call zeroext i1 @"_ZN4core3fmt3num52_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$u8$GT$3fmt17he2a12ceea2b3531eE"(i8* align 1 dereferenceable(1) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f)
  %2 = zext i1 %1 to i8
...
; call core::fmt::num::imp::<impl core::fmt::Display for u8>::fmt
  %5 = call zeroext i1 @"_ZN4core3fmt3num3imp51_$LT$impl$u20$core..fmt..Display$u20$for$u20$u8$GT$3fmt17h3f54ebc340b1c55fE"(i8* align 1 dereferenceable(1) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f)
  %6 = zext i1 %5 to i8
...
; call core::fmt::num::<impl core::fmt::UpperHex for u8>::fmt
  %7 = call zeroext i1 @"_ZN4core3fmt3num52_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$u8$GT$3fmt17h3ebed2cb1d32a499E"(i8* align 1 dereferenceable(1) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f)
  %8 = zext i1 %7 to i8
...
; Function Attrs: uwtable
define zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h632d559c5d1a455fE"(i8** align 8 dereferenceable(8) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f) unnamed_addr #1 {
start:
  %_4 = load i8*, i8** %self, align 8, !nonnull !1
; call core::fmt::num::<impl core::fmt::Debug for u8>::fmt
  %0 = call zeroext i1 @"_ZN4core3fmt3num49_$LT$impl$u20$core..fmt..Debug$u20$for$u20$u8$GT$3fmt17h59b60e76c3e689b6E"(i8* align 1 dereferenceable(1) %_4, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f)
  br label %bb1
...
; Function Attrs: uwtable
declare void @_ZN3std3sys4unix17thread_local_dtor13register_dtor17h72ecae9b26a9e6cdE(i8*, void (i8*)* nonnull) unnamed_addr #1
...
declare void @_ZN4core9panicking19assert_failed_inner17hc78c8626996b7beaE(i8, {}* nonnull align 1, [3 x i64]* align 8 dereferenceable(24), {}* nonnull align 1, [3 x i64]* align 8 dereferenceable(24), %"core::option::Option<core::fmt::Arguments>"* noalias nocapture dereferenceable(48), %"core::panic::location::Location"* align 8 dereferenceable(24)) unnamed_addr #4

; <std::thread::local::AccessError as core::fmt::Debug>::fmt
; Function Attrs: uwtable
declare zeroext i1 @"_ZN68_$LT$std..thread..local..AccessError$u20$as$u20$core..fmt..Debug$GT$3fmt17hbf585db32979d6afE"(%"std::thread::local::AccessError"* nonnull align 1, %"core::fmt::Formatter"* align 8 dereferenceable(64)) unnamed_addr #1

; core::result::unwrap_failed
; Function Attrs: cold noinline noreturn uwtable
declare void @_ZN4core6result13unwrap_failed17hf19da9b6244b79beE([0 x i8]* nonnull align 1, i64, {}* nonnull align 1, [3 x i64]* align 8 dereferenceable(24), %"core::panic::location::Location"* align 8 dereferenceable(24)) unnamed_addr #5

; core::fmt::Formatter::debug_lower_hex
; Function Attrs: uwtable
declare zeroext i1 @_ZN4core3fmt9Formatter15debug_lower_hex17h898b568dc3d01406E(%"core::fmt::Formatter"* align 8 dereferenceable(64)) unnamed_addr #1

; core::fmt::num::<impl core::fmt::LowerHex for u8>::fmt
; Function Attrs: uwtable
declare zeroext i1 @"_ZN4core3fmt3num52_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$u8$GT$3fmt17he2a12ceea2b3531eE"(i8* align 1 dereferenceable(1), %"core::fmt::Formatter"* align 8 dereferenceable(64)) unnamed_addr #1

; core::fmt::Formatter::debug_upper_hex
; Function Attrs: uwtable
declare zeroext i1 @_ZN4core3fmt9Formatter15debug_upper_hex17h961ff7a2fc077a54E(%"core::fmt::Formatter"* align 8 dereferenceable(64)) unnamed_addr #1

; core::fmt::num::<impl core::fmt::UpperHex for u8>::fmt
; Function Attrs: uwtable
declare zeroext i1 @"_ZN4core3fmt3num52_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$u8$GT$3fmt17h3ebed2cb1d32a499E"(i8* align 1 dereferenceable(1), %"core::fmt::Formatter"* align 8 dereferenceable(64)) unnamed_addr #1

; core::fmt::num::imp::<impl core::fmt::Display for u8>::fmt
; Function Attrs: uwtable
declare zeroext i1 @"_ZN4core3fmt3num3imp51_$LT$impl$u20$core..fmt..Display$u20$for$u20$u8$GT$3fmt17h3f54ebc340b1c55fE"(i8* align 1 dereferenceable(1), %"core::fmt::Formatter"* align 8 dereferenceable(64)) unnamed_addr #1
...
attributes #2 = { cold noreturn uwtable "frame-pointer"="all" "probe-stack"="__rust_probestack" "target-cpu"="core2" }
